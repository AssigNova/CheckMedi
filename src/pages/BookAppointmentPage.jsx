...
export default function BookAppointmentPage() {
  ...
  return (
    <div style={pageStyle}>
      <h1 style={{ textAlign: 'center', fontSize: '1.875rem', fontWeight: 'bold', color: '#111827', marginBottom: '12px' }}>Book an Appointment</h1>
      ...
      <div style={gridStyle}>
        {loading ? (
          ...
          <p style={{ textAlign: 'center', fontSize: '1rem', color: '#4b5563', padding: '40px', width: '100%' }}>No doctors available at the moment.</p>
        )}
      </div>
    </div>
  );
